...
func _usage(error: String) -> void:
	...
	print("Usage:")
	print("  godot --headless --path . --script res://converters/convert_model.gd -- --source res://assets/raw_original_content/3DDATA/Units/AT_inf_H0.xbf")
	print("Options:")
	print("  --output res://assets/converted/models/AT_inf_H0/AT_inf_H0.scn")
