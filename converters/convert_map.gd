...
const MapBakeBuilderScript := preload("res://converters/map_bake_builder.gd")
...
func _init() -> void:
	...
	if output_dir.is_empty():
		output_dir = "res://assets/converted/maps".path_join(source_dir.get_file())
...
func _usage(error: String) -> void:
	...
	print("Usage:")
	print("  godot --headless --path . --script res://converters/convert_map.gd -- --source res://assets/raw_original_content/MAPS/#M70\\ Claw\\ Rock")
	print("Options:")
	print("  --output res://assets/converted/maps/<name>")
