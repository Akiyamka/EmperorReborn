...
OpenEBfD is a Godot 4 project whose goal is to make a native and browser-playable version
...
make godot-convert-projectiles    # bullet, muzzle-flash, and impact models referenced by Rules/ArtIni
